...
for(let key in obj1){
    if(obj1[key] == 22){
        console.log("Первая, буква: ", key);
    }
}

for(let key in obj2){
    if(obj2[key] == 22){
        console.log("Вторая, буква: ", key);
    }
}

for(let key in obj3){
    if(obj3[key] == 22){
        console.log("Третья, буква: ", key);
    }
}

for(let key in obj4){
    if(obj4[key] == 22){
        console.log("Четвертая, буква: ", key);
    }
}

for(let key in obj5){
    if(obj5[key] == 22){
        console.log("Пятая, буква: ", key);
    }
}

for(let key in obj6){
    if(obj6[key] == 22){
        console.log("Шестая, буква: ", key);
    }
}

for(let key in obj7){
    if(obj7[key] == 22){
        console.log("Седьмая, буква: ", key);
    }
}

for(let key in obj8){
    if(obj8[key] == 22){
        console.log("Последняя, буква: ", key);
    }
}
